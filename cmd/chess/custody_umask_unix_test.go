...
// The mode passed to open is filtered by the umask, so a restrictive umask
// would publish a key this program cannot later write. Only an explicit
// Chmod on the open descriptor makes the promised mode true.
